  ...
  <div class="createPost-container">
    <el-form ref="postForm" v-if="!loading" :model="postForm" :rules="rules" class="form-container">
      ...
      <div class="createPost-main-container">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="Địa chỉ" label-width="120px" class="text-left">
              <el-input v-model="postForm.address" placeholder="Địa chỉ" :maxlength="100"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item label="Số điện thoại" label-width="120px" class="text-left">
              <el-input v-model="postForm.phoneNumber" placeholder="Số điện thoại" :maxlength="100"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item label="Email" label-width="120px" class="text-left">
              <el-input v-model="postForm.email" placeholder="Email" :maxlength="100"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
      </div>
  ...
  methods: {
    ...
    getRemoteUserList(query) {
      searchUser(query).then(response => {
        if (!response) return;
        this.listOptions = response.map(v => v.name);
      });
    }
  }
};
